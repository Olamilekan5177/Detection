...
""")
    ...
    client_id = input("\n📋 SENTINEL_HUB_CLIENT_ID: f59d7210-46d3-498f-9d71-2c22d2dd42b4").strip()
    client_secret = input("🔐 SENTINEL_HUB_CLIENT_SECRET:5b2527a7-565b-4442-a805-66fb6526a3cc ").strip()
