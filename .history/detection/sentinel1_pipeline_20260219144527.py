...
class Sentinel1QueryEngine:
    ...
    def search_tiles(
        ...
        try:
            ...
            # Build simplified OData filter query for Sentinel Data Space Catalog API
            # Using only the fields that Copernicus API actually supports
            filters = [
            ...
            # Build spatial filter for bbox using geo intersection
            # Format: geo.intersects(Geometry, geography'SRID=4326;POLYGON((lon1 lat1, lon2 lat2, ...))')
            ...
            # Combine filters
            final_filter = f"{filter_str} and {spatial_filter}"
